...
\begin{frame}{Special kinds of subgroups!}
  ...
  \begin{block}{Cyclic subgroups}
    Every element $g \in G$ generates a \Balert{cyclic subgroup} $\<g\>=\big\{g^k\mid k\in\Z\big\}$.\Pause

    In other words, a \Balert{cyclic subgroup} is one that's generated by a single element.
  \end{block}\Pause
...
\begin{frame}{The center of a group}
  ...
  \begin{block}{Center}
    The \Alert{center} of a group $G$ is the set of all elements that commute with everybody: \Pause
