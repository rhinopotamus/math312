...
\begin{frame}{``Reducing'' subgroup lattices}
  ...
  Left-subscripts denote size. We call this a \Alert{subgroup diagram} (bc it might not actually be a lattice.)
  ...
  \begin{tikzpicture}[shorten >= -2pt, shorten <= -2pt,scale=.75,auto,xscale=1.1]
    %%
    \newcommand\Hh{8} % height of A_5
    \newcommand\Hg{7} % height of A_4
    \newcommand\Hf{6} % height of D_10
    \newcommand\He{5} % height of S_3
    \newcommand\Hd{4} % height of C_5
    \newcommand\Hc{3} % height of V_4
    \newcommand\Hb{2} % height of C_3
    \newcommand\Ha{1} % height of C_2  
    \tikzstyle{every node}=[font=\footnotesize]
    %%
    \node (A5) at (0,\Hh) {\small $A_5$};
    %%
